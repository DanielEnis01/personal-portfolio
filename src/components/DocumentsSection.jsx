...
const documents = [
  {
    ...
    primaryAction: { label: 'Download PDF', icon: Download, href: '/Resume/DanielEnisResume27.pdf' },
    secondaryAction: { label: 'View Online', icon: ExternalLink, href: '/Resume/DanielEnisResume27.pdf' },
